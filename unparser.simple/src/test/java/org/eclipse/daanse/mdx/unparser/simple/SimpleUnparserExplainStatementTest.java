...
class SimpleUnparserExplainStatementTest {
    ...
    void test1() {
        ...
        assertThat(unparser.unparseExplainStatement(explainStatement)).asString()
                .isEqualTo("EXPLAIN PLAN FOR" + System.lineSeparator() + " SELECT {[Date],[Calendar],[Calendar Year],&[2001]} ON COLUMNS FROM "
                        + "[Adventure Works]");
    }
    ...
    void test2() {
        ...
        assertThat(unparser.unparseExplainStatement(explainStatement)).asString()
                .isEqualTo("EXPLAIN PLAN FOR" + System.lineSeparator() + " DRILLTHROUGH" + System.lineSeparator() + " MAXROWS 10" + System.lineSeparator() + " FIRSTROWSET 1" + System.lineSeparator()
