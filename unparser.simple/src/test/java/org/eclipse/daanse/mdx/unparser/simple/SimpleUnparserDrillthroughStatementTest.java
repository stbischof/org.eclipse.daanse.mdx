...
class SimpleUnparserDrillthroughStatementTest {
    ...
    void test() {
        ...
        assertThat(unparser.unparseDrillthroughStatement(drillthroughStatement)).asString().isEqualTo(
                "DRILLTHROUGH" + System.lineSeparator() + " MAXROWS 10" + System.lineSeparator() + " FIRSTROWSET 1" + System.lineSeparator() + " SELECT {[Date],[Calendar],[Calendar Year],&[2001]} ON COLUMNS FROM [Adventure Works]");
    }
}
